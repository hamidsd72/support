    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="box-sh container-fluid">
          <form class="row" action="{{route('todo.list.cc.user.store',$cat->id)}}" method="post">
            @csrf
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="users_cc">کاربر *</label>
            ...
            <tr>
              ...
              <td>
                <div class="form-group d-flex">
                  <form action="{{route('todo.list.cc.user.delete',$data->id)}}" method="POST">
                    {{method_field('DELETE')}}
                    {{csrf_field()}}
