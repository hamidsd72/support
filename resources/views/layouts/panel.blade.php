...
{{--        integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">--}}
  ...
  <link rel="shortcut icon" href="http://www.adibhost.com/support/img/logo.png">
    ...
    <div class="header-part-right">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right notification-dropdown rtl-ps-none ps"
          ...
          {{--                            </p>--}}
          {{--                            <p class="text-small text-muted m-0">به پنل جدید ادیب خوش آمدید</p>--}}
          {{--                        </div>--}}
          {{--                    </div>--}}
      ...
      <div class="dropdown">
        <div class="user col align-self-end">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            @endif
            <a class="dropdown-item" href="{{route('profile.show', auth()->user()->id)}}">پروفایل</a>
      ...
      @else
        ...
        @if (Auth::user()->role_id != 5)
          <ul class="childNav" data-parent="pages" style="display: none;">
            <li class="nav-item"><a href="http://adib-it.com/"><i class="nav-icon i-URL-Window"></i><span
                        class="item-name">صفحه اصلی</span></a></li>
            <li class="nav-item"><a href="http://adibhost.com/support/"><i
                        class="nav-icon i-URL-Window"></i><span
                        class="item-name">ناحیه کاربری</span></a></li>
            <li class="nav-item"><a href="http://adib-it.com/درباره-ما/"><i
                        class="nav-icon i-URL-Window"></i><span class="item-name">درباره ما</span></a>
            </li>
            <li class="nav-item"><a href="http://adib-it.com/تماس-با-ما/"><i
    ...
    <div class="container" style="direction: rtl">
      ...
      @if(auth()->user()->role_id!=5)
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="{{ route('agreement.index') }}"  class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
        ...
        <div class="pull-right w-100 hidden-mob" style="margin-right: -15px;display: none;">
          <div class="container">
            <div class="row">
              <div class="fcon">
                <div class="col-md-2 pull-right">
                  <a href="http://adibcomputer.com/%D9%86%D8%B5%D8%A8-%D9%88-%D8%B1%D8%A7%D9%87-%D8%A7%D9%86%D8%AF%D8%A7%D8%B2%DB%8C-%D8%B4%D8%A8%DA%A9%D9%87/">
                    <div class="prosda animated bounceIn">
                      <img src="{{ asset('img/net2.jpg') }}" alt="">
                      {{--<img src="http://adib-it.com/cdn/assets/img/server.png" alt="">--}}
                      <h5 class="title">نصب و راه اندازی شبکه</h5>
                    </div>
                  </a>
                </div>
                <div class="col-md-2 pull-right">
                  <a href="http://adibcomputer.com/%D8%AE%D8%AF%D9%85%D8%A7%D8%AA-%D8%B4%D8%A8%DA%A9%D9%87/">
                    <div class="prosda animated bounceIn">
                      <img src="{{ asset('img/net.jpg') }}" alt="">
                      {{--<img src="http://adib-it.com/cdn/assets/img/database.png" alt="">--}}
                      <h5 class="title">خدمات شبکه</h5>
                    </div>
                  </a>
                </div>
                <div class="col-md-2 pull-right">
                  <a href="http://adibcomputer.com/%D8%AE%D8%AF%D9%85%D8%A7%D8%AA-%D8%A7%D8%AC%D8%B1%D8%A7%DB%8C%DB%8C-%D9%85%D8%B1%D8%A8%D9%88%D8%B7-%D8%A8%D9%87-%D9%BE%D8%B4%D8%AA%DB%8C%D8%A8%D8%A7%D9%86%DB%8C-%D8%B4%D8%A8%DA%A9%D9%87/">
                    <div class="prosda animated bounceIn">
                      <img src="{{ asset('img/net3.jpg') }}" alt="">
                      {{--<img src="http://adib-it.com/cdn/assets/img/cust.png" alt="">--}}
                      <h5 class="title">پشتیبانی شبکه</h5>
                    </div>
                  </a>
                </div>
                <div class="col-md-2 pull-right">
                  <a href="http://adibcomputer.com/%D8%AE%D8%AF%D9%85%D8%A7%D8%AA-%D8%B3%DB%8C%D8%B3%DA%A9%D9%88/">
                    <div class="prosda animated bounceIn">
                      <img src="{{ asset('img/sisco.jpg') }}" alt="">
                      {{--<img src="http://adib-it.com/cdn/assets/img/clud.png" alt="">--}}
                      <h5 class="title">خدمات سیسکو</h5>
                    </div>
                  </a>
                </div>
                <div class="col-md-2 pull-right">
                  <a href="http://adibcomputer.com/%D9%BE%D8%B4%D8%AA%DB%8C%D8%A8%D8%A7%D9%86%DB%8C-voip/">
                    <div class="prosda animated bounceIn">
                      <img src="{{ asset('img/voip.jpg') }}" alt="">
                      {{--<img src="http://adib-it.com/cdn/assets/img/back-up.png" alt="">--}}
                      <h5 class="title">پشتیبانی VOIP</h5>
                    </div>
                  </a>
                </div>
                <div class="col-md-2 pull-right">
                  <a href="http://adibcomputer.com/%D8%AE%D8%AF%D9%85%D8%A7%D8%AA-%D9%85%DB%8C%DA%A9%D8%B1%D9%88%D8%AA%DB%8C%DA%A9/">
                    <div class="prosda animated bounceIn">
                      <img src="{{ asset('img/micro.jpg') }}" alt="">
                      {{--<img src="http://adib-it.com/cdn/assets/img/servers.png" alt="">--}}
      ...
      <div class="row">
        ...
        <footer class="col-md-12 footer">
          ...
          <p class="pull-right">Copyright © 2017 | Design & Develop by <a href="http://adib-it.com/"
...
<script>
    $(function () {
        $('#sales').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://adib-it.com/support/api/store_sale_info',
                // url: 'http://adibhost.com/support/api/store_sale_info',
    ...
    <script>
        $(document).ready(function () {
            function has_tick() {
                ...
                $.get("http://adibhost.com/support/has_ticket/" + id, function (data) {
                    if (data == "ok") {
                        (new PNotify({
                                title: 'تیکت',
                                type: 'success',
                                ...
                                desktop: {
                                    desktop: true,
                                    icon: 'http://adibhost.com/support/img/success.png'
                                }
                            })
                        )
                    } else {
